...
$(document).ready(function(){
    ...
    $('.booking_steps_cont .ok_btn').click(function(){
        $('.booking_steps_cont').fadeOut();
        setTimeout(function(){
            $('.booking_steps_cont').next('.main-div').fadeIn();
        },500);
    });
        ...
        success: function(res)
        {
          ...
          else if(data.status === true)
          {
            //console.log(data.Password);
             $('.booking_steps_cont').next('.main-div').fadeOut();
             setTimeout(function(){
                $('.booking_steps_cont').next('.main-div').next('.email_sent_popup').find('.email_field').text($('#email_form>#email').val());
                $('.booking_steps_cont').next('.main-div').next('.email_sent_popup').fadeIn();
...
<script>
  ...
  $(function(){
    $(document).change('#booking_form #chooseOnMap', function(){
        console.log(gMapLat);
        console.log(gMapLng);
        console.log(gMapZoom);
  ...
  function initMap() 
  {
    ...
    autocomplete.addListener('place_changed callinitmap', function() {
        infowindow.close();
